...
public class theClient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        JLabel attach = new javax.swing.JLabel();
        ...
        attach.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/download.png")));
        attach.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/download.png")));
        ...
        isConnnected.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8_connect_30px.png")));
    ...
    private void SendMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        if (file != null) {
            if (file.exists()) {
                ...
                sentMessage.append("File Sent: " + file.getName() + "\n");
                
            } else {
                sentMessage.append("File does not exist: " + file.getName() + "\n");
            }
            file = null; // Reset the selected file
        } else {
